    ...
    public partial class detailedlistforloan : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                try
                {
                    // http://localhost:63011/WebForm/Loan/detailedlistforloan?ardb_cd=21&brn_cd=101&acc_cd=20411&adt_dt=23/05/2022 
                    ...
                    prp.ardb_cd = Request.QueryString["ardb_cd"];
                    ...
                    paramss[0] = new ReportParameter("p_bank_name", brn_name, false);
