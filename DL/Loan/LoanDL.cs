    ...
    public class LoanDL
    {
        ...
        internal List<tt_detailed_list_loan> GetDefaultList(p_report_param prp)
        {
            ...
            string _query = " SELECT TT_DETAILED_LIST_LOAN.ACC_CD,             "
                           ...
                           + " TT_DETAILED_LIST_LOAN.COMPUTED_TILL_DT          "
                           + " FROM TT_DETAILED_LIST_LOAN                      "
                           + " WHERE   ( TT_DETAILED_LIST_LOAN.ACC_CD = '{0}' )  AND  ( TT_DETAILED_LIST_LOAN.ARDB_CD = '{1}' ) "
        ...
        internal List<demand_list> GetDemandList(demand_list prp)
        {
            ...
            string _query = " SELECT DISTINCT TT_BLOCK_ACTI_DEMAND1.ARDB_CD,TT_BLOCK_ACTI_DEMAND1.LOAN_ID,             "
                           + " TT_BLOCK_ACTI_DEMAND1.ACTIVITY_CD,           "
                           + " TT_BLOCK_ACTI_DEMAND1.CURR_PRN,            "
                           + " TT_BLOCK_ACTI_DEMAND1.OVD_PRN,                 "
                           + " TT_BLOCK_ACTI_DEMAND1.CURR_INTT,                  "
                           + " TT_BLOCK_ACTI_DEMAND1.OVD_INTT,                "
                           + " TT_BLOCK_ACTI_DEMAND1.PENAL_INTT,                 "
                           + " TT_BLOCK_ACTI_DEMAND1.DISB_DT,                 "
                           + " TT_BLOCK_ACTI_DEMAND1.OUTSTANDING_PRN,                  "
                           + " TT_BLOCK_ACTI_DEMAND1.UPTO_1,               "
                           + " TT_BLOCK_ACTI_DEMAND1.ABOVE_1,          "
                           + " TT_BLOCK_ACTI_DEMAND1.ABOVE_2,          "
                           + " TT_BLOCK_ACTI_DEMAND1.ABOVE_3,          "
                           + " TT_BLOCK_ACTI_DEMAND1.ABOVE_4,          "
                           + " TT_BLOCK_ACTI_DEMAND1.ABOVE_5,          "
                           + " TT_BLOCK_ACTI_DEMAND1.ABOVE_6,          "
                           + " TT_BLOCK_ACTI_DEMAND1.PARTY_NAME,          "
                           + " TT_BLOCK_ACTI_DEMAND1.BLOCK_NAME,          "
                           + " TT_BLOCK_ACTI_DEMAND1.SERVICE_AREA_NAME,          "
                           + " TT_BLOCK_ACTI_DEMAND1.VILL_NAME,          "
                           + " TT_BLOCK_ACTI_DEMAND1.MONTH,          "
                           + " TT_BLOCK_ACTI_DEMAND1.ACC_CD,          "
                            + " TT_BLOCK_ACTI_DEMAND1.LOAN_ACC_NO          "
                           + " FROM TT_BLOCK_ACTI_DEMAND1               ";
                            ...
                            using (var reader = command.ExecuteReader())
                            {
                                if (reader.HasRows)
                                {
                                    while (reader.Read())
                                    {
                                        ...
                                        loanDtl.outstanding_prn = UtilityM.CheckNull<decimal>(reader["OURSTANDING_PRN"]);
                                        ...
                                        loanDtl.month = UtilityM.CheckNull<decimal>(reader["MONTH"]);
                                        loanDtl.acc_cd = Convert.ToInt32(UtilityM.CheckNull<Int32>(reader["ACC_CD"]));                                                                                       
