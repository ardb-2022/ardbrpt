                ...
                {   
                    try{    
                            ...
                            using (var command = OrclDbConnection.Command(connection, _statement))
                            {
                                    ...
                                    var parm1 = new OracleParameter("as_ardb_cd", OracleDbType.Char, ParameterDirection.Input);
                                    parm1.Value = prp.ardb_cd;
                                    command.Parameters.Add(parm1);
                                    var parm2 = new OracleParameter("as_brn_cd", OracleDbType.Char, ParameterDirection.Input);
